        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-y-auto">
            ...
            <div className="bg-black relative group" style={{ aspectRatio: "16/9" }}>
                ...
                <div className="flex items-center justify-between bg-black/60 backdrop-blur-sm rounded-xl px-4 py-2">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-9 h-9 bg-white dark:bg-[#1E244F] rounded-full flex items-center justify-center hover:scale-110 transition-transform"
                    >
              ...
              >
                <div className={`w-16 h-16 bg-white dark:bg-[#1E244F]/20 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/40 hover:bg-white dark:bg-[#1E244F]/30 transition-all ${playing ? "opacity-0" : "opacity-100"}`}>
            ...
            {/* Lesson Info */}
            <div className="p-6 bg-white dark:bg-[#1E244F] border-b border-slate-200">
          ...
          {/* Right: Lesson List */}
          {showSidebar && (
            <div className="w-80 bg-white dark:bg-[#1E244F] border-r border-slate-200 overflow-y-auto flex-shrink-0">
