      ...
      <div className="max-w-5xl mx-auto p-6 lg:p-8 space-y-6 lg:space-y-8">
        ...
        <div className="rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="bg-gradient-to-br from-[#B348FE] to-[#9E2FFF] px-6 lg:px-8 pt-0 pb-6 lg:pb-8 relative overflow-hidden">
            ...
            <div className="relative flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6 lg:gap-8 -mt-12 sm:-mt-14 lg:-mt-16">
              {/* Avatar */}
              ...
              {/* Info */}
              <div className="flex-1 flex flex-col justify-center text-center sm:text-right mt-1 sm:mt-6 lg:mt-8">
                {editing ? (
                  <div className="mb-2">
                    <input
                      value={editName}
