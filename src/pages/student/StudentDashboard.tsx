      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-64 h-64 bg-white dark:bg-[#130726]/5 rounded-full -translate-x-1/3 -translate-y-1/3"></div>
            <div className="relative">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="bg-white dark:bg-[#130726]/20 rounded-2xl p-3 text-center min-w-[80px]">
                  <p className="text-white font-black text-2xl">#12</p>
                  <p className="text-blue-200 text-xs">ترتيبك</p>
                </div>
              </div>
              <div className="mt-5 flex items-center gap-4">
                <div className="flex items-center gap-2 bg-white dark:bg-[#130726]/10 rounded-xl px-3 py-2">
