    ...
    <DashboardLayout type="instructor" sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen}>
      <div dir="rtl" className="min-h-screen bg-white">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-black truncate">بطولة الأسئلة</h1>
            </div>
          </div>
        </motion.div>
        ...
        <div className="flex flex-col items-center justify-center text-center py-20 sm:py-28 px-4">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-blue-50 flex items-center justify-center mb-4 sm:mb-5">
            <Swords className="text-[#1547D6]" size={32} />
          </div>
          <span className="inline-block mb-3 px-3.5 py-1.5 rounded-full text-xs font-black bg-blue-50 text-[#1547D6]">
            قريبًا
          </span>
          <h2 className="text-lg sm:text-xl font-black text-gray-800">الميزة دي هتتاح قريبًا</h2>
        </div>
