...
type ItemType = "video" | "pdf" | "quiz" | "homework" | "link";
...
type CourseItem = VideoItem | PdfItem | QuizItem | HomeworkItem | LinkItem;
...
function createDefaultLink(): LinkItem {
  return {
    type: "link",
    id: generateId(),
    title: "رابط جديد",
                    ...
                    <div className="p-2 space-y-1">
                      {[
                        ...
                        },
                        {
                          ...
                          label: "رابط خارجي",
                          desc: "إضافة رابط لموقع أو ملف خارجي",
                          color: "text-cyan-600 bg-cyan-50 hover:bg-cyan-100",
                          iconBg: "bg-cyan-100",
                          icon: <svg className="w-5 h-5 text-cyan-600" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 010 5.656l-3 3a4 4 0 01-5.656-5.656l1.5-1.5M10.172 13.828a4 4 0 010-5.656l3-3a4 4 0 015.656 5.656l-1.5 1.5" /></svg>,
                        },
                      ].map((opt) => (
                        <button
                          key={opt.type}
    ...
    <DashboardLayout type="instructor" sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen}>
      <div dir="rtl" className="min-h-screen bg-white">
        ...
        <div className="mx-4 sm:mx-6 py-8 space-y-6">
          ...
          {/* Stats Row */}
          <EditCourseStats sectionsCount={course.sections.length} sections={course.sections} />
