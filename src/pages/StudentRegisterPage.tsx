...
const SECTIONS = ['علمي رياضة', 'علمي علوم', 'أدبي', 'تجاري', 'صناعي'];
  ...
  const [form, setForm] = useState({
    name: '', phone: '', email: '', grade: '', section: '', password: '', confirmPassword: '',
  });
  ...
  const inputClass = `w-full rounded-2xl px-4 py-3.5 text-sm font-medium outline-none border transition-all duration-300 ${
    isDark
      ? 'bg-white dark:bg-[#130726]/[0.045] border-white/[0.09] text-white placeholder-white/25 focus:border-purple-500 focus:bg-white dark:bg-[#130726] dark:bg-[#130726]/[0.07]'
      : 'bg-slate-50 border-slate-200 text-slate-800 placeholder-slate-400 focus:border-purple-500 focus:bg-white dark:bg-[#130726] dark:bg-[#130726]'
  }`;
  ...
  const validate = () => {
    ...
    if (form.name.trim().length < 3) e.name = 'الاسم يجب أن يكون 3 أحرف على الأقل';
            ...
            <div className="max-w-[420px] mx-auto w-full">
              ...
              >
                ...
                <p className="text-sm" style={{ color: isDark ? 'rgba(255,255,255,0.48)' : '#64748B' }}>
                  أنشئ حسابك وابدأ رحلة التعلم الآن
                </p>
              </motion.div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-black mb-1" style={{ color: isDark ? '#FCD34D' : '#92400E' }}>
                      طلاب السنتر لا يحتاجون إلى إنشاء حساب جديد
                    </p>
                    <p className="text-xs leading-relaxed mb-3" style={{ color: isDark ? 'rgba(252,211,77,0.6)' : '#B45309' }}>
                      يتم تسجيل بياناتهم من خلال إدارة السنتر والحصول على كود الطالب. بعد استلام الكود قم بتفعيل حسابك.
                    </p>
                    <motion.button
                      type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <User className="absolute top-1/2 -translate-y-1/2 right-4 w-[18px] h-[18px] text-purple-500" />
                      <input
                        type="text"
