  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden" dir="rtl">
      ...
      <main className="flex-1 overflow-y-auto">
        {/* Top Bar */}
        <div className="sticky top-0 z-10 bg-white dark:bg-[#1E244F]/95 backdrop-blur-sm border-b border-slate-200 px-6 py-4 flex items-center justify-between">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl text-sm font-bold transition-all ${
                  activeSection === tab.key
                    ...
                    : "bg-white dark:bg-[#1E244F] text-slate-600 border border-slate-200 hover:border-slate-300"
                }`}
              >
                {tab.label}
              </button>
