...
export function LeaderboardCard({
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <h3 className="mt-3 text-sm sm:text-base font-black text-slate-900 dark:text-white truncate max-w-[190px]">
        {student.full_name}
      </h3>
      ...
      <span
        className={`mt-2 inline-block px-3 py-1 rounded-full text-[11px] font-black ${badgeLabelColor[student.badge]}`}
      >
