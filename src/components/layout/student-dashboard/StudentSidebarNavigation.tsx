                ...
                <div
                  ...
                  className={cn(
                    ...
                    isActiveParent
                      ...
                      : "text-gray-700 dark:text-gray-300 hover:bg-[#F6EEFF] dark:hover:bg-[#1A1A1A] hover:text-[#5800a9] dark:hover:text-[#b600d7]"
                  )}
                >
                  <div
                    className={cn(
                      ...
                      isActiveParent
                        ? "bg-white/20"
                        : "bg-[#F6EEFF] text-[#5800a9] dark:bg-[#2B103D] dark:text-[#b600d7]"
                    )}
                  >
                    {item.icon}
                  </div>
